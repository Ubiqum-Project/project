...
close(pb)
} else{bbc= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes)  }
...
close(pb)
} else{bcn= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{cd= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{cnbc= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{cndk= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{fbbtc= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{fbsrch= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{fr= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{gf= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{gplus= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{rba= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{rbb= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{rbm= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{rbc= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{rbmine= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{reu= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{blm= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
}else{scmp= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{tw= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{iet= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{yn= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{you= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
#----------->you Date Cleaning Function -------------------------
if(length(zh)>0){
...
close(pb)
}else{zh= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
#----------->you Date Cleaning Function -------------------------
if(length(wsj)>0){
...
close(pb)
}else{wsj= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{ccn= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
close(pb)
}else{rbx= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
...
}else{frt= data.frame(timeNOWGMT,name,articleTime,title, paragraph, source, price_gfbtc, price_gf_delta_btc, api_last_btc, api_vol_btc,api_bid_btc , combination, text, datez, cleaned, DateNotes) }
#--------------------------BEGIN CONCATENATION-----------------------------------------
...
z <- gzfile("Full_DB_cleaned_with_dates.csv.gz")
write.csv(final, z)

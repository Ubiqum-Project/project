...
toBeNormalized = read.csv(gzfile("Full_DB_secondary_Predictor_Pull.csv.gz"), stringsAsFactors=FALSE)
...
######################################################################################################################
forContinutity = read.csv("FullDBPull.csv.gz")
...
z <- gzfile("FullDBDataOutput.csv.gz")
write.csv(data, z)
...
gridRate
  ggsave("plots/fullDBgridValue.jpeg",gridValue, device = "jpeg", width = 15, height = 10, limitsize = F)
  ggsave("plots/fullDBgridRate.jpeg",gridRate, device = "jpeg", width = 15, height = 10, limitsize = F)
  ggsave("plots/fullDBseismicValue.jpeg",seismicValue, device = "jpeg", width = 15, height = 10, limitsize = F)
  ggsave("plots/fullDBseismicRate.jpeg",seismicRate, device = "jpeg", width = 15, height = 10, limitsize = F)
